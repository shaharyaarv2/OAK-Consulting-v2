...
>
    ...
    <div className="max-w-7xl mx-auto w-full max-h-full overflow-y-auto scrollbar-hide py-10 md:py-8">
        ...
        {/* 3. MAP SECTION */}
        <div ref={sectionRefs.current[2]} className="h-screen flex flex-col justify-center items-center bg-[#0f0f0f] p-4 sm:p-6">
            <div className="max-w-7xl w-full text-center mb-8">
                ...
                <div className="flex justify-center mt-3"><div className="h-1 bg-[#ff6600] w-20"></div></div>
            </div>
            <div className="max-w-5xl w-full h-[65vh] mx-auto rounded-xl overflow-hidden shadow-2xl border border-gray-800">
